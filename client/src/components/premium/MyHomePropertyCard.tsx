...
interface MyHomePropertyCardProps {
  property: any;
...
export function MyHomePropertyCard({ 
  property, 
  onDelete, 
  isDeleting, 
  applicationCount,
  ...
  return (
    ...
    >
      ...
      <div className="p-6 space-y-4 flex-1 flex flex-col">
        ...
        {showActions && (
          <div className="flex gap-2 pt-2 border-t-2 border-slate-100 dark:border-slate-700 mt-2">
            <PremiumButton
              variant="outline"
